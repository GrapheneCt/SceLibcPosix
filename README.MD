...
6. You're good to go!
(7.) Optional: set `unsigned int sceLibcPosixDisableFios2Init = 1` if you want to initialize FIOS2 yourself. By default it is initialized automatically by SceLibcPosix on startup.
